...
(to-bool (SKI-IsZero SKI-One))
(to-bool (SKI-IsZero SKI-Null))
(to-bool (SKI-IsZero (SKI-Minus SKI-Three SKI-Two)))
(to-bool (SKI-IsZero (SKI-Minus SKI-Two SKI-Two)))
...
(to-int-list (SKI-Map (fn [x] (SKI-Plus x SKI-One)) (SKI-ConsRangeList SKI-Null)))
...
(to-int (SKI-ReduceL SKI-Reducer-Ex1 SKI-Null (SKI-ConsRangeList SKI-Ten)))
(to-int (SKI-Reduce SKI-Reducer-Ex1 SKI-Null (SKI-ConsZeroList SKI-Ten)))
...
; Ski-Test-Sum sums three elelemnts. We use Apply to apply this function to a list containing 3 elements
